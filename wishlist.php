    ...
    <div class="wishlist-box-main">
       ...
       <!--================================================--> 
                                ...
                                if(!isset($_SESSION["username"])){echo"<tr>No result</tr>";}
                                    ...
                                    $id=$_SESSION["username"];
                                    $sql="select * from wishlist where username='$id'";
                                    $result=$conn->query($sql);
                                    if($result->num_rows<1){echo"<tr><td>No result <td></tr>";}
                                    else{
                                        while($row=$result->fetch_assoc()){
                                    ...
                                    <td class="thumbnail-img">
                                        <a href="#">
                                            <img class="img-fluid" src="<?php echo"admin/doc/".$row1['image']; ?>" alt="" />
					</a>
                                    </td>
                                    <td class="name-pr">
                                        <a href="#">
                                    ...
                                    <td class="remove-pr">
                                        <a href="removewish.php?action=remove&id=<?php echo $row1["pro_id"];?>">
