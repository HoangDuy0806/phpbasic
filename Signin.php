...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $reaccountt=$conn->query($sql);
    $kt=false;
    while($row=$reaccountt->fetch_assoc()){
    ...
    if($kt==true){
        ...
        $sql1="INSERT INTO `customer`(`username`, `name`, `email`, `phone`, `address`) "
                . "VALUES ('$user','$name','$email','$phone','$address')";
                ...
                <div class="col-sm-12 col-lg-12 mb-3">
                    ...
                    <form class="mt-3 review-form-box" method="POST">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="InputName" class="mb-0">Phone</label>
                        ...
                        <button class="btn hvr-hover"><a href="login.php">Login</a></button>
                        <button class="btn hvr-hover"><a href="index.php">HOME</a></button>
                    </form>
                </div>
            </div>
