...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql1="INSERT INTO `account`(`username`, `password`) VALUES ('$username','$password')";
    $sql="INSERT INTO `customer`(`username`, `name`, `email`, `address`, `phone`) "
...
<main class="app-content">
    <div class="app-title">
      <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Create Customer</a></li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
