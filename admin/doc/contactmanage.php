...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item active" href="#"><i class='app-menu__icon bx bx-calendar-check'></i><span
        ...
        <div class="tile">
          <div class="tile-body">
            ...
            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
              ...
              <tbody>
                  <?php 
                  $result=$contact->showAllContact($conn);
                ...
                <tr>
                  ...
                  <td class="table-td-center"><a class="btn btn-primary btn-sm trash" 
                         href="deletecontact.php?action=remove&id=<?php echo $row["contactID"];?>">
