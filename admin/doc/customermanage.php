        ...
        <div class="tile">
          <div class="tile-body">
            <div class="row element-button">
              <div class="col-sm-2">
                  <a class="btn btn-add btn-sm" href="addcustomer.php" title="Thêm"><i class="fas fa-plus"></i>
                  Create customer</a>
              </div>
            </div>
                ...
                <tr>
                  ...
                  <td class="table-td-center">
                      <a class="btn btn-primary btn-sm trash" 
                         href="deletecustomer.php?action=remove&id=<?php echo $row["username"];?>">
                          <i class="fas fa-trash-alt"></i></a>
                    <a class="btn btn-primary btn-sm edit"
                       href="editcustomer.php?action=edit&id=<?php echo $row["username"];?>">
