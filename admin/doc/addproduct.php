...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql="INSERT INTO `product`(`pro_id`, `pro_name`, `amount`, `price`, `image`,`description`) "
            . "VALUES ('$pro_id','$name','$amount','$price','$target','$description')";
          ...
          <div class="tile-body">
            <div class="row element-button">
              ...
              <div class="form-group col-md-4">
                ...
                <input class="form-control" name="pro_id" type="text" required="">
              </div>
                <div class="form-group col-md-4">
