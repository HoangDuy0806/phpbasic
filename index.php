            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="<?php echo "admin/doc/".$row['image']; ?>" alt="" />
                        <a class="btn hvr-hover" href="detail.php?action=view&id=<?php echo $row["pro_id"];?>"><?php echo$row["pro_name"];?></a>
                    </div>
                </div>
                <?php } ?>
<!--                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <div class="blog-box">
                        ...
                        <div class="blog-content">
                            ...
                            <ul class="option-blog">
                                ...
                                <li><a href="detail.php?action=view&id=<?php echo$row['pro_id'];?>"><i class="fas fa-eye"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
